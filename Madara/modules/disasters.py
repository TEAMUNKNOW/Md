...
from Madara import DEMONS, DEV_USERS, DRAGONS, OWNER_ID, TIGERS, WOLVES, dispatcher
from Madara.modules.helper_funcs.chat_status import dev_plus, sudo_plus, whitelist_plus
from Madara.modules.helper_funcs.extraction import extract_user
from Madara.modules.log_channel import gloggable

ELEVATED_USERS_FILE = os.path.join(os.getcwd(), "Madara/elevated_users.json")
...
def addwhitelist(update: Update, context: CallbackContext) -> str:
    ...
    if user_id in WOLVES:
        message.reply_text("ᴛʜɪs ᴜsᴇʀ ɪs ᴀʟʀᴇᴀᴅʏ ᴀ ᴛʀᴜᴇ ʜʏᴅʀᴀ")
        return ""
    ...
    update.effective_message.reply_text(
        f"{rt}\nsᴜᴄᴄᴇssғᴜʟʟʏ ᴘʀᴏᴍᴏᴛᴇᴅ {user_member.first_name} ᴛᴏ ᴀ ʀᴀɴᴋᴇᴅ Madara!"
    )
...
def addtiger(update: Update, context: CallbackContext) -> str:
    ...
    if user_id in WOLVES:
        rt += "ᴛʜɪs ᴜsᴇʀ ɪs ᴀʟʀᴇᴀᴅʏ a ʜʏᴅʀᴀ, ᴡᴇ ᴄᴀɴ ʙᴇ ᴄʟᴀssᴍᴀᴛᴇs ᴀs ᴡᴇʟʟ.."
        data["whitelists"].remove(user_id)
        WOLVES.remove(user_id)
...
def removewhitelist(update: Update, context: CallbackContext) -> str:
    ...
    if user_id in WOLVES:
        ...
        return log_message
    message.reply_text("ᴛʜɪs ᴜsᴇʀ ɪs ɴᴏᴛ ᴀ ʜʏᴅʀᴀ!")
    return ""
...
def whitelistlist(update: Update, context: CallbackContext):
    ...
    m = update.effective_message.reply_text(
        "<code>ɢᴀᴛʜᴇʀɪɴɢ ɪɴᴛᴇʟ ғʀᴏᴍ ʜʏᴅʀᴀ ʜǫ.</code>",
...
WHITELIST_HANDLER = CommandHandler(
    ("Madara", "addwhitelist"), addwhitelist, run_async=True
)
...
WHITELISTLIST_HANDLER = CommandHandler(
    ["whitelistlist", "HYDRAS"], whitelistlist, run_async=True
)
TIGERLIST_HANDLER = CommandHandler(
    ["classmates", "tigerlistlist"], tigerlist, run_async=True
)
